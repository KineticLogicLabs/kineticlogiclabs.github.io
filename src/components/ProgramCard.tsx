    ...
    >
      ...
      <div className="space-y-6 relative z-10">
        ...
        <div className="space-y-2">
          <h4 className="text-xl md:text-2xl font-sans font-bold text-charcoal tracking-tight group-hover:text-accent-blue transition-colors duration-300">
            {program.title}
          </h4>
          <p className="font-sans italic text-xs text-charcoal-muted font-light leading-relaxed border-l-2 border-accent-blue/20 pl-3">
            "{program.tagline}"
          </p>
        </div>
