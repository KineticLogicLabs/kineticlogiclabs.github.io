          ...
          return (
            <div
              ...
              className={`glass-sheet transition-all duration-300 rounded-xl relative ${
                isExpanded 
                  ? 'border-accent-blue/35 bg-[rgb(38,33,29)] shadow-md' 
                  : 'hover:border-accent-blue/25 hover:bg-[rgb(34,29,26)] cursor-pointer'
              }`}
              ...
              <div className="p-5 md:p-6 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="space-y-1">
                    ...
                    <h4 className="text-lg md:text-xl font-sans font-bold text-charcoal">
                      {weekData.title}
                    </h4>
                  </div>
                        ...
                        <div className="space-y-2.5 pl-2">
                          {extraDetails[weekData.week]?.map((unitText, uIdx) => (
                            <div key={uIdx} className="flex items-start gap-2.5">
                              ...
                              <span className="font-sans text-xs text-charcoal-light leading-relaxed">
                                {unitText}
                              </span>
                            </div>
                          ))}
