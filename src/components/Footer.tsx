...
export default function Footer({ setActiveTab }: FooterProps) {
  ...
  return (
    <footer className="bg-bone-warm border-t border-accent-blue/15 relative z-10 w-full" id="global-footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 items-start">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs font-mono text-charcoal-light">
              ...
              <li>
                <button onClick={() => handleNav('courses')} className="hover:text-accent-blue transition-colors text-left">
                  Courses
                </button>
              </li>
              <li>
