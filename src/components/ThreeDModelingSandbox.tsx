      ...
      <div className="lg:col-span-4 flex flex-col justify-between glass-sheet p-6 rounded-2xl relative overflow-hidden" id="sandbox-controls-panel">
        ...
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <h3 className="text-2xl font-sans font-bold text-charcoal tracking-tight">
              Geometric Engine
            </h3>
                ...
                <button
                  ...
                  className={`px-3 py-2 text-left rounded-lg text-xs font-mono tracking-tight transition-all duration-300 flex items-center justify-between border ${
                    options.meshType === item.type
                      ? 'bg-[rgb(53,134,162)]/15 text-[rgb(53,134,162)] border-[rgb(53,134,162)]/30 font-semibold'
                      : 'bg-bone-warm/30 text-charcoal-light border-[rgb(53,134,162)]/5 hover:bg-bone-warm hover:text-charcoal'
                  }`}
                >
                  <span>{item.label}</span>
                  <span className={`h-1.5 w-1.5 rounded-full ${options.meshType === item.type ? 'bg-[rgb(53,134,162)]' : 'bg-transparent'}`} />
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="mt-8 p-3 rounded-lg bg-bone-warm/40 border border-accent-blue/10 space-y-2" id="sandbox-formula-log">
          ...
          <p className="text-[10px] font-sans text-charcoal-muted leading-snug">
            {meshFormula.desc}
          </p>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center z-10">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="p-2.5 rounded-full bg-[rgb(53,134,162)]/10 hover:bg-[rgb(53,134,162)]/20 text-[rgb(53,134,162)] transition-all duration-300"
              title={isRotating ? 'Pause Orbit' : 'Resume Orbit'}
              id="btn-toggle-rotation"
            >
              {isRotating ? <Pause className="w-4 h-4 fill-[rgb(53,134,162)]/10" /> : <Play className="w-4 h-4 fill-[rgb(53,134,162)]/10" />}
            </button>
            
            {/* Reset angles button */}
            <button
              onClick={() => setAngles({ yaw: 0.4, pitch: -0.5, roll: 0.1 })}
              className="p-2.5 rounded-full bg-[rgb(53,134,162)]/5 hover:bg-[rgb(53,134,162)]/15 text-charcoal-light hover:text-[rgb(53,134,162)] transition-all duration-300"
