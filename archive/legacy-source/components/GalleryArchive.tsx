    ...
    <div className="space-y-8" id="gallery-archive-root">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-2">
          ...
          <h3 className="text-3xl font-sans font-bold text-charcoal tracking-tight">
            Student Work Archive
          </h3>
          <p className="font-sans text-sm text-charcoal-muted max-w-2xl leading-relaxed">
        ...
        {/* Legend block */}
        <div className="hidden md:block text-[10px] font-mono text-charcoal-muted border border-accent-blue/10 bg-bone-warm rounded px-3 py-2 leading-relaxed">
          <span>PROJECTS_AUDITED: <strong className="text-accent-blue">{String(studentProjects.length).padStart(2, '0')} ACTIVE</strong></span><br />
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="space-y-1.5">
                <h4 className="text-lg md:text-xl font-sans font-bold text-charcoal group-hover:text-accent-blue transition-colors duration-300">
                  {proj.title}
                </h4>
                ...
                {selectedProj === proj.id && (
                  ...
                  >
                    <div className="pt-4 border-t border-accent-blue/10 space-y-2 mt-4 text-[11px] font-mono text-charcoal-light bg-bone-warm/30 p-3 rounded border border-accent-blue/5">
                      ...
                      <div className="text-[10px] text-charcoal-muted italic mt-1 font-sans leading-snug">
