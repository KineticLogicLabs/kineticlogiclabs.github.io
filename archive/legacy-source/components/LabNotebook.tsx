    ...
    <div className="space-y-8" id="lab-notebook-root">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg border transition-all duration-300 ${
                activeCategory === cat
                  ? 'bg-[rgb(53,134,162)] text-white border-[rgb(53,134,162)]/45 font-semibold'
                  : 'bg-bone-warm/30 text-charcoal-light border-[rgb(53,134,162)]/10 hover:bg-bone-warm hover:text-[rgb(53,134,162)] hover:border-[rgb(53,134,162)]/30'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="notebook-entries-grid">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <h4 className="text-lg font-sans font-bold text-charcoal leading-snug group-hover:text-accent-blue transition-colors duration-300">
                  {entry.title}
                </h4>
        ...
        {filteredEntries.length === 0 && (
          <div className="col-span-full py-12 text-center text-sm font-sans text-charcoal-muted">
