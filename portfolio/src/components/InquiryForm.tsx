...
export default function InquiryForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const bodyContent = `Name: ${formData.name}\n\nMessage:\n${formData.message}\n\n---\nSent using the Kinetic Logic Labs website`;
        ...
        {!submitted ? (
          ...
          >
            ...
            <button
              ...
              className="w-full bg-[rgb(53,134,162)] hover:bg-opacity-95 disabled:bg-[rgb(53,134,162)]/70 text-white border border-[rgb(53,134,162)]/30 font-mono text-xs font-bold tracking-widest uppercase py-4 rounded-lg flex items-center justify-center gap-2 transition-all duration-200 cursor-pointer active:translate-y-px"
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="font-sans text-sm text-charcoal-muted max-w-sm mx-auto leading-relaxed">
                Thank you, <strong className="text-charcoal font-medium">{formData.name}</strong>. Please make sure to press <strong className="text-accent-blue font-bold">Send</strong> on the email application popup that just opened to deliver your message.
              </p>
            </div>

            <button
              onClick={handleReset}
              className="px-5 py-2.5 text-xs font-mono tracking-wider uppercase bg-bone-warm/30 hover:bg-[rgb(53,134,162)] text-[rgb(53,134,162)] hover:text-white rounded-lg transition-all duration-250 cursor-pointer border border-[rgb(53,134,162)]/25 hover:border-[rgb(53,134,162)]"
            >
